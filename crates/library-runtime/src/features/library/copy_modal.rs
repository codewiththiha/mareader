...
use crate::services::{CopyAnswer, CopyAsk, answer_copy, cancel_copy};
...
#[component]
pub(crate) fn CopyModal(state: crate::context::LibraryContext) -> impl IntoView {
...
#[component]
fn CopySheet(state: crate::context::LibraryContext, ask: CopyAsk) -> impl IntoView {
