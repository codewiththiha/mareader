...
//!
//! Contract: primitives must not know what a PDF reader is. No `app_state`,
//! `reader_runtime`, `library_runtime`, or `pdf_engine` imports below this
//! point (pure math may come from `pdf_core`, which is dependency-free and
//! host-testable).
