        ...
        <Row label=label>
            <StyleSelect
                ...
                on_change=Callback::new(move |choice: FontChoice| {
                    update_text(update, move |t| write(t, choice.clone()));
                })
...
#[component]
pub(crate) fn FontsTab(state: crate::context::ReaderContext) -> impl IntoView {
    let s = state.settings;
    ...
    view! {
        ...
        <div class="divide-y divide-line rounded-xl border border-line">
            ...
            <StepperRow
                ...
                on_minus=Callback::new(move |_| {
                    update_text(s, |t| t.font_size -= 1.0);
                })
            ...
            <StepperRow
                ...
                on_minus=Callback::new(move |_| {
                    update_text(s, |t| t.font_weight = t.font_weight.saturating_sub(100));
                })
                on_plus=Callback::new(move |_| {
                    update_text(s, |t| t.font_weight = t.font_weight.saturating_add(100));
                })
        ...
        <div class="divide-y divide-line rounded-xl border border-line">
            <StepperRow
                ...
                on_minus=Callback::new(move |_| {
                    update_text(s, |t| t.line_height -= 0.1);
                })
                on_plus=Callback::new(move |_| {
                    update_text(s, |t| t.line_height += 0.1);
                })
            ...
            <StepperRow
                ...
                on_minus=Callback::new(move |_| {
                    update_text(s, |t| t.paragraph_margin -= 0.25);
                })
                on_plus=Callback::new(move |_| {
                    update_text(s, |t| t.paragraph_margin += 0.25);
                })
            ...
            <StepperRow
                ...
                on_minus=Callback::new(move |_| {
                    update_text(s, |t| t.word_spacing -= 0.5);
                })
                on_plus=Callback::new(move |_| {
                    update_text(s, |t| t.word_spacing += 0.5);
                })
            ...
            <StepperRow
                ...
                on_minus=Callback::new(move |_| {
                    update_text(s, |t| t.letter_spacing -= 0.01);
                })
                on_plus=Callback::new(move |_| {
                    update_text(s, |t| t.letter_spacing += 0.01);
                })
            ...
            <StepperRow
                ...
                on_minus=Callback::new(move |_| {
                    update_text(s, |t| t.text_indent -= 0.5);
                })
                on_plus=Callback::new(move |_| {
                    update_text(s, |t| t.text_indent += 0.5);
                })
        ...
        <div class="divide-y divide-line rounded-xl border border-line">
            <Row label="Column Align">
                <StyleSelect
                    ...
                    on_change=Callback::new(move |v: TextColumnAlign| {
                        update_text(s, move |t| t.column_align = v);
                    })
                    options=vec![
            ...
            <Row label="Use Book Layout">
                <Switch
                    ...
                    on_change=Callback::new(move |v| {
                        update_text(s, move |t| t.book_layout = v);
                    })
            ...
            <Row label="Full Justification">
                <Switch
                    ...
                    on_change=Callback::new(move |v| {
                        update_text(s, move |t| t.justify = v);
                    })
            ...
            <Row label="Hyphenation">
                <Switch
                    ...
                    on_change=Callback::new(move |v| {
                        update_text(s, move |t| t.hyphenation = v);
                    })
