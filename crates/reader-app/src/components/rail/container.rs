...
//! mounted from one of two places — [`crate::components::rail::push`]
//! (docked, a flex sibling of the page) or
//! [`crate::components::rail::overlay`] (floating, a fixed
...
///
/// A CustomEvent rather than a signal in `ReaderState`: this is a one-shot
