...
//!   * [`floating_title`] — the difference-blend document name parked over the
//!     top-left of the slot, which measures the page host under the eyes to
//!     decide whether it fits.
//!
//! The reactive primitives these components read are NOT here: they live in
//! `crate::state::viewer` (a plain signals bundle) and in `reader-core`'s
