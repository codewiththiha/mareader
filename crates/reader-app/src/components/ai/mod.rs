...
//!     that drive them.
//!
//! The AI's appearance knobs are NOT here: they edit the global settings
//! blob, so they are the settings modal's tab section and live with it
//! (`components/settings/ai.rs` in the shell crate).
