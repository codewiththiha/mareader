//! Chunk ingestion: one window listener (fed by the shell's app-lifetime
//! Tauri bridge) that turns `mareader:ai-chunk` events into
...
use ai_core::types::{AiChunk, AiChunkEvent};
use ui_kit::events::AI_CHUNK_EVENT;
use crate::state::ReaderState;

pub fn use_ai_chunks(state: ReaderState, ctrl: GlossController) {
