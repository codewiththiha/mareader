...
use ui_kit::primitives::motion::spring::SpringBox;
...
pub fn use_open_listener(reader: ReaderState, ctrl: GlossController) {
    ...
    Effect::new(move |_| {
        ...
        match verdict {
            ...
            OpenVerdict::Open => {
                ...
                let mark = begin_open(reader, ctrl, &watch, &spring, viewport, pending);
