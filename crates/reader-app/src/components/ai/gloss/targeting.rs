...
use ui_kit::primitives::motion::reduced_motion::reduced_motion_signal;
use ui_kit::primitives::motion::spring::{SpringBox, use_spring_box};
...
pub fn use_card_targeting(reader: ReaderState, ctrl: GlossController) -> CardTargeting {
