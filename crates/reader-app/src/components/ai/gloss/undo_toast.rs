...
use ui_kit::primitives::overlay::toast::{ToastAction, ToastData, ToastPanel, ToastTone};
use ui_kit::primitives::overlay::toast_host::use_toast_slot;
                ...
                ToastData {
                    ...
                    action: Some(ToastAction {
                        ...
                        on_click: Callback::new(move |_| {
                            ...
                            if reader.document.path.get_untracked() == batch_path {
