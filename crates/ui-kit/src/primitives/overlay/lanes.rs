...
//!   dismissal stay in [`crate::primitives::floating`]; this module
...
impl Lanes {
    ...
    /// Anchored menus and popovers ([`MenuPopover`](crate::primitives::floating::menu_popover::MenuPopover)-hosted).
