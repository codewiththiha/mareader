...
//!   `reader_runtime::components::formats::pdf::canvas`,
//!   `reader_runtime::components::formats::reflow::page` and
//!   `reader_runtime::components::formats::reflow::stream`. The first thing the
...
//!   (`reader_runtime::components::ai::selection_pill`).
//!
//! Element ids are built, not spelled:
//! `reader_runtime::components::viewer::page_host` owns
//! [`reader_runtime::components::viewer::page_host::host_id_for_mode`] (the
//! `sp-`/`dp-`/`hp-`/`cont-` hosts and their `-cv` canvases) and
//! [`reader_runtime::components::viewer::page_host::block_row_id`], and
//! `reader_runtime::components::formats::pdf::strip` owns the `-wrap` rows around a
...
/// [`reader_runtime::components::viewer::page_host::block_row_id`], resolved per mark
/// per refresh.
...
/// on its way. `reader_runtime::components::formats::pdf::canvas_host` creates and
...
/// div (`reader_runtime::components::formats::pdf::canvas`); the engine fills it with
