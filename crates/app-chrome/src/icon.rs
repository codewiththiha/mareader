...
fn icon_data(name: IconName) -> (&'static str, &'static str) {
    ...
    match name {
        IconName::Open => (
            "0 0 24 24",
            "<path d='M2 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z'/><path d='M2 10h20'/>",
        ),
        IconName::ZoomIn => (
            "0 0 24 24",
        ...
        IconName::FitWidth => (
            "0 0 24 24",
            "<path d='M3 5v14M21 5v14'/><path d='M8 9l-3 3 3 3M16 9l3 3-3 3'/>",
        ),
        IconName::FitPage => (
            "0 0 24 24",
            "<rect x='4' y='4' width='16' height='16' rx='2'/><path d='m9 9 6 6M9 15l6-6'/>",
        ),
        ...
        IconName::EyeOff => (
            "0 0 24 24",
            "<path d='M10.73 5.08A10.75 10.75 0 0 1 12 5a10.75 10.75 0 0 1 9.94 6.65 1 1 0 0 1 0 .7 10.75 10.75 0 0 1-4.43 5.14'/><path d='M6.61 6.61A10.75 10.75 0 0 0 2.06 11.65a1 1 0 0 0 0 .7 10.75 10.75 0 0 0 15.31 5.04'/><path d='M14.12 14.12a3 3 0 1 1-4.24-4.24'/><path d='m2 2 20 20'/>",
        ),
        ...
        IconName::SinglePage => (
            "0 0 24 24",
            "<rect x='4' y='3' width='16' height='18' rx='2'/><path d='M4 9h16'/>",
        ),
        IconName::DualPage => (
            "0 0 24 24",
        ...
        IconName::Continuous => (
            "0 0 24 24",
            "<rect x='4' y='3' width='16' height='4' rx='1'/><rect x='4' y='10' width='16' height='4' rx='1'/><rect x='4' y='17' width='16' height='4' rx='1'/>",
        ),
        IconName::HScroll => (
            "0 0 24 24",
        ...
        IconName::SidebarOpen => (
            "0 0 24 24",
            "<rect x='3' y='4' width='18' height='16' rx='2'/><path d='M9 4v16'/><path d='M4.5 5.5H9v13H4.5z' fill='currentColor' stroke='none'/>",
        ),
        IconName::Palette => (
            "0 0 24 24",
            "<path d='M12 22a10 10 0 1 1 10-10c0 2-1.5 3-3 3h-2a2 2 0 0 0-2 2c0 1 .5 1.5 1 2s-1 3-4 3z'/>",
        ),
        IconName::Type => (
            "0 0 24 24",
        ...
        IconName::Keyboard => (
            "0 0 24 24",
            "<path d='M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z'/><path d='M6 10h.01 M10 10h.01 M14 10h.01 M18 10h.01 M6 14h.01 M18 14h.01 M10 14h4'/>",
        ),
        IconName::Pin => (
            "0 0 24 24",
        ...
        IconName::Drop => (
            "0 0 24 24",
            "<path d='M12 3v11'/><path d='m7 11 5 5 5-5'/><path d='M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2'/>",
        ),
        ...
        IconName::WindowRestore => (
            "0 0 24 24",
            "<rect x='8' y='8' width='11' height='11' rx='1'/><path d='M5 15V6a1 1 0 0 1 1-1h9'/>",
        ),
    }
}
