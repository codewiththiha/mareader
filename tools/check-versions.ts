...
// [package].version). Release tags and artifact filenames derive from
// it, so any drift breaks releases invisibly; this script fails CI when they
...
// nothing ever wrote the bump back. `mareader-shell` sat at 0.7.0 in the committed
// lock through a whole 0.8.0 release with all four sources above in agreement, and
