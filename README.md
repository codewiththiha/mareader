...
- 1,085 Rust tests across the workspace, plus a stub-vm smoke suite for the TypeScript
...
1,085 tests cover the pure layer: zoom and fit maths, page layout and spread stepping,
