...
//!
//! These are the AI feature's knobs, but they edit the GLOBAL settings blob,
//! which is the shell's to own — so they are a tab section like any other, and
//! `settings::theme::ThemeTab` composes [`AiAppearanceSection`] the way it
//! composes the rest. What is NOT here is the reader's own colour — tint,
//! textures and theme presets belong to the title bar's palette menu, and the
//! tab says so at its foot.
